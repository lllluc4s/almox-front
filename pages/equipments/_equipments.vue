<template>
	<div>
		...
		<div>
			<table
				class="table-auto border-separate border-spacing-4 border border-slate-500 w-full text-center p-1 mt-20"
			>
				<thead>
					<tr>
				...
				<tbody>
					<tr v-for="item in equipments" :key="item.id">
						...
						<td
							class="border border-slate-600 px-2 py-2 flex justify-center items-center"
						>
							<svg
